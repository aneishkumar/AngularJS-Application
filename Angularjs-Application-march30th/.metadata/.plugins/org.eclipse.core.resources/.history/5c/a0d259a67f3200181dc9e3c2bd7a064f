...
public class UserDAOImpl implements UserDAO {
	...
	public List<User> gettallsuggesteduser(String username) {
		...
		String queryString="select * User_Registration where username in (select username from User_Registration where username!=? minus (select fromid from friends where toid=?  union select toid from friends where fromid=? ))";
