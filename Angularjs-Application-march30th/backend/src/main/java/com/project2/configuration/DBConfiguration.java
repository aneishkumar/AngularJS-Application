...
import com.project2.model.Test;
...
public class DBConfiguration {
  ...
  @Bean
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{User.class,Blog.class,ProfilePicture.class,BlogPicture.class,JobApplied.class,BlogComment.class,BlogLikes.class,BlogLikesNumber.class,Friends.class,Notification.class,NotificationNumber.class,FriendRequestsNumber.class,Job.class};//class objects of all entities
