...
import com.project2.model.BlogComments;
...
public class DBConfiguration {
  ...
  @Bean
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{User.class,Blog.class,ProfilePicture.class,BlogComment.class,Friends.class,Notification.class,NotificationNumber.class,FriendRequestsNumber.class};//class objects of all entities
