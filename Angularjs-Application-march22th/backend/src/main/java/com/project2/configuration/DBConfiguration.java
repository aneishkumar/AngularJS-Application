...
public class DBConfiguration {
  ...
  @Bean
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{User.class,Blog.class,ProfilePicture.class,BlogComment.class,Notification.class,NotificationNumber.class};//class objects of all entities
